...
const LayoutPayment = () => {
  ...
  return (
    <div className="flex flex-col items-center w-full gap-6">
      <div className="flex items-center gap-5 w-fit justify-center dark:border-gray-800 dark:bg-[#242526] dark:text-white bg-white p-3 border-gray-300 border-3 rounded-lg ">
